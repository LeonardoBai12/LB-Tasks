...
import io.lb.lbtasks.login.presentation.screens.LoginHomeScreen
...
fun MainNavigation() {
    ...
    NavHost(
        ...
        startDestination = MainScreens.LoginHomeScreen.name
    ) {
        composable(MainScreens.LoginHomeScreen.name) {
